...
elemento que iguale al valor que entra, no haga la inserción (es decir no se insertan valores
repetidos). Imprima el vector actualizado. Imprima el valor y la posición en que se
...
*La información se imprime en el programa principal.
